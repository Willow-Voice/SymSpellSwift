...
Or if you have the symspellpy repo as a sibling directory, it will use that.
"""
...
# Try to import from symspellpy package, or from sibling repo
try:
    ...
    # Try sibling repo
    sibling_repo = Path(__file__).parent.parent.parent / "symspellpy"
    if sibling_repo.exists():
        ...
        raise ImportError(
            "symspellpy package not found. Install with: pip install symspellpy\n"
            "Or clone symspellpy repo as a sibling directory."
        )
